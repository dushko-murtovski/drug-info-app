import painkiller from '../../assets/cats/pain-killer.png'
import cough from '../../assets/cats/cough.png'
import influenza from '../../assets/cats/influenza.png'
import digestion from '../../assets/cats/digestion.png'
import pill from '../../assets/cats/pill.png'
import skincare from '../../assets/cats/skincare.png'

import advil from '../../assets/painkillers/advil.png'
import asperine from '../../assets/painkillers/asperine.png'
import etosIbuprofen from '../../assets/painkillers/etosIbuprofen.png'
import excedrin from '../../assets/painkillers/excedrin.png'

export const categories = [
  {
    id: 3,
    name: 'Pijnstillers',
    photo_url: painkiller
  },
  {
    id: 1,
    name: 'Verkoudheid, hoest of keelpijn',
    photo_url: cough
  },
  {
    id: 2,
  ...
  {
    id: 0,
    name: 'Kruidengeneesmiddelen',
    photo_url: pill
  },
  {
    id: 5,
    name: 'Middelen voor de',
    photo_url: skincare
...
export const recipes = [
  {
    ...
    photo_url: advil,
    photosArray: [
      'https://i-cf65.ch-static.com/content/dam/cf-consumer-healthcare/bp-advil-v2/en_US/products/product-01/advil-tablets.png?auto=format',
      'https://media.istockphoto.com/id/484824216/photo/pills-of-aspirin-and-advil.jpg?s=612x612&w=0&k=20&c=I9epucggZnSMt2oacn3bcCcPyJr3Bp0MWpD5yEXZd0E=',
      'https://st.depositphotos.com/55493816/53674/i/600/depositphotos_536747356-stock-photo-bangkok-thailand-december-2021-pain.jpg',
      'https://i-cf65.ch-static.com/content/dam/cf-consumer-healthcare/bp-advil/nl_NL/products/Advil_Reliva_Liquid_Caps_200mg-20ct-Facing_Front.png?auto=format'
    ],
    time: '15',
  ...
  },
  {
    recipeId: 3,
    categoryId: 3,
    title: 'Etos Ibuprofen',
    photo_url: etosIbuprofen,
    photosArray: [
